...
public protocol TravellerWayFindingProtocol {
    ...
    func present<T>(to destination: ControllerDestination, modelPresentationStyle: UIModalPresentationStyle, modelTransistionStyle: UIModalTransitionStyle, hidesTopBar: Bool, hidesBottomBar: Bool, animated: Bool, configure: ((T) -> Void)?) -> T? where T : UIViewController
    func performSegue<T>(to destination: ControllerDestination , storyBoardProtocol: TravellerStoryBoardProtocol, modelTransistionStyle: UIModalTransitionStyle, hidesTopBar: Bool, hidesBottomBar: Bool, animated: Bool, configure: ((T) -> Void)?) -> T? where T : UIViewController
