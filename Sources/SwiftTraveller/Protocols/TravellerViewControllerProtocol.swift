...
public protocol TravellerViewControllerProtocol: class {
    ...
    static func makeViewController<T>(for controller: ControllerDestination, storyBoard: TravellerStoryBoardProtocol?,  modelPresentationStyle: UIModalPresentationStyle?, modelTransistionStyle: UIModalTransitionStyle?) -> T? where T: UIViewController
